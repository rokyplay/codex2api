...
export function randomPassword(prefix) {
  ...
  if (!passwordPrefix) {
    ...
    for (var p = prefixChars.length - 1; p > 0; p--) {
      var swapIndex = randInt(0, p);
      var temp = prefixChars[p];
      prefixChars[p] = prefixChars[swapIndex];
      prefixChars[swapIndex] = temp;
    }
    passwordPrefix = prefixChars.join('');
  }
